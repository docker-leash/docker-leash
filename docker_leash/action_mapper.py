...
class ActionMapper(object):
    ...
    _MAP = {
        'GET': {
            ...
            r'^/v\d.\d{2}/images/[a-zA-Z0-9/:_-]+/json$': 'imagesInspect',
            r'^/v\d.\d{2}/images/[a-zA-Z0-9/:_-]+/history$': 'imagesHistory',
            r'^/v\d.\d{2}/images/search(\?.*)?(#.*)?$': 'imagesSearch',
            r'^/v\d.\d{2}/images/[a-zA-Z0-9/:_-]+/get$': 'imagesExport',
        ...
        'POST': {
            ...
            r'^/v\d.\d{2}/images/[a-zA-Z0-9/:_-]+/push(\?.*)?(#.*)?$': 'imagesPush',
            r'^/v\d.\d{2}/images/[a-zA-Z0-9/:_-]+/tag(\?.*)?(#.*)?$': 'imagesTag',
        ...
        'DELETE': {
            ...
            r'^/v\d.\d{2}/images/[a-zA-Z0-9/:_-]+(\?.*)?(#.*)?$': 'imagesRemove',
